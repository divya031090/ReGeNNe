...
geneinfile = 'gene_data.csv'
metadata = 'gene_metadata.txt'
# Split 70% of data as training and 30% as test
train_ratio = 0.7
metavar = ['disease_stat','disease_status']  
levels = ['Positive','Negative']
# Read data
data = gene_input.data_metadata_gene(geneinfile,metadata,train_ratio,metavar,levels)
